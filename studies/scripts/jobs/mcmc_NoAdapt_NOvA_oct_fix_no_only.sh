...
./install/bin/MCMCTutorial /nfs/scratch0/hwallace/software/MaCh3Tutorial/studies/configs/FitterConfig_NoAdapt_oct_fix_no_only_NOvA.yaml  General:OutputFile:/nfs/scratch0/hwallace/software/MaCh3Tutorial/studies/NoAdapt/NOvA/mcmc_NoAdapt_NOvA_oct_fix_no_only.root AdaptionOptions:Settings:OutputFileName:/nfs/scratch0/hwallace/software/MaCh3Tutorial/studies/NoAdapt/NOvA/mcmc_NoAdapt_NOvA_oct_fix_no_only_cov.root 
./install/bin/DiagMCMC /nfs/scratch0/hwallace/software/MaCh3Tutorial/studies/NoAdapt/NOvA/mcmc_NoAdapt_NOvA_oct_fix_no_only.root /nfs/scratch0/hwallace/software/MaCh3Tutorial/studies/configs/FitterConfig_NoAdapt_oct_fix_no_only_NOvA.yaml
