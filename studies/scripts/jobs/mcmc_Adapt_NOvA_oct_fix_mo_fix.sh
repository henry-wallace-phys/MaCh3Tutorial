...
./install/bin/MCMCTutorial /nfs/scratch0/hwallace/software/MaCh3Tutorial/studies/configs/FitterConfig_Adapt_oct_fix_mo_fix_NOvA.yaml  General:OutputFile:/nfs/scratch0/hwallace/software/MaCh3Tutorial/studies/Adapt/NOvA/mcmc_Adapt_NOvA_oct_fix_mo_fix.root AdaptionOptions:Settings:OutputFileName:/nfs/scratch0/hwallace/software/MaCh3Tutorial/studies/Adapt/NOvA/mcmc_Adapt_NOvA_oct_fix_mo_fix_cov.root 
./install/bin/DiagMCMC /nfs/scratch0/hwallace/software/MaCh3Tutorial/studies/Adapt/NOvA/mcmc_Adapt_NOvA_oct_fix_mo_fix.root /nfs/scratch0/hwallace/software/MaCh3Tutorial/studies/configs/FitterConfig_Adapt_oct_fix_mo_fix_NOvA.yaml
